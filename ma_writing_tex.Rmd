...
output:
  pdf_document:
    ...
    includes:
      ...
      keep_tex: true
      pandoc_args: [
      "-V", "linestretch=2"  # This sets the line spacing to double
    ]
...
Social movement research has a long-standing tradition in academia. Its development, some argue, started from what scholars have called the "psychometric" [@eidlinSocialClassSocial2018] approach. This approach focused on the
